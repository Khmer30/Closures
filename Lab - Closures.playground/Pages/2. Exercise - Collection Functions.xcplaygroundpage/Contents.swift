...
let names = ["Bob", "Dav", "June"]
var sortedCollection1 = names.sorted(by: forwards)
...
var sortedCollection2 = names.sorted(by: {(name1: String, name2: String) -> Bool in return name1 < name2 })
...
var sortedCollection3 = names.sorted(by: { $0 < $1 })
